...
The following code will populate the 'data' directory with the relevant data files from the Open Science Framework project __ if the 'data' directory is empty.__  
