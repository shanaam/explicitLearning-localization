...
```
__Result: Odds of getting a score of 3 vs 1 or 0 combined is 4.7 times greater when instruction is provided (assuming rotation size is kept constant). Likewise, odds of getting 3 or 1 is 4.7 times greater when instruction is provided (over getting 0).  __
